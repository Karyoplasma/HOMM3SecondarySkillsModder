...
import actions.ChangesTableMouseAdapter;
...
public class Heroes3HeroEditor {
	...
	private void initialize() {
		...
		frmHommSecondarySkill.getContentPane()
				.setLayout(new MigLayout("", "[][][grow][][]", "[][:100px:200px][][][][][][][][grow][]"));
		...
		btnUpdateHero.setEnabled(false);
		...
		frmHommSecondarySkill.getContentPane().add(scrollPaneHeroInfo, "cell 2 0 3 3,grow");
		...
		lblHeroInfo.setHorizontalAlignment(SwingConstants.RIGHT);
		lblHeroInfo.setFont(new Font("Tahoma", Font.BOLD, 14));
		frmHommSecondarySkill.getContentPane().add(lblHeroInfo, "cell 1 1,alignx right,growy");
		...
		tableChanges.addMouseListener(new ChangesTableMouseAdapter(this));
	...
	public JButton getBtnUpdateHero() {
		return btnUpdateHero;
	}
	...
	public void setHeroes(Map<String, Hero> heroes) {
		...
		this.changes.clear();
		this.btnWriteFile.setEnabled(false);
